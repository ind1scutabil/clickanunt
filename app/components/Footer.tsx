        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="https://instagram.com" target="_blank" rel="noopener" className="text-gray-400 hover:text-[#FF7900] transition">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/" className="hover:text-[#FF7900] transition">
                  Acasă
                </Link>
              </li>
              <li>
                <Link href="/listings" className="hover:text-[#FF7900] transition">
                  Anunțuri
                </Link>
              </li>
              <li>
                <Link href="/listings/new" className="hover:text-[#FF7900] transition">
                  Adaugă Anunț
                </Link>
              </li>
              <li>
                <Link href="/contact" className="hover:text-[#FF7900] transition">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="tel:+40XXXXXXXXX" className="hover:text-[#FF7900] transition">
                  📱 +40 XXX XXX XXX
                </a>
              </li>
