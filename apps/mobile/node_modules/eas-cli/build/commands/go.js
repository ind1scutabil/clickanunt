...
class Go extends EasCommand_1.default {
    ...
    async runAsync() {
        log_1.default.log(chalk_1.default.bold(`Creating your personal Expo Go and deploying to TestFlight. ${(0, log_1.learnMore)('https://expo.fyi/personal-expo-go')}`));
    ...
    async monitorWorkflowJobsAsync(graphqlClient, workflowRunId) {
        const buildSpinner = (0, ora_1.ora)('Building Expo Go').start();
        ...
        while (true) {
            try {
                ...
                if (buildCompleted && submitSpinner === null && submitJob) {
                    submitSpinner = (0, ora_1.ora)('Submitting to TestFlight').start();
                }
