// ============================================
// CATEGORII SI SUBCATEGORII — derived from TAXONOMY SSOT
// ============================================
import { TAXONOMY } from "@/lib/taxonomy";

/** Label → subcategory labels. Kept in sync with lib/taxonomy.ts (do not hand-edit). */
export const CATEGORIES: Record<string, string[]> = Object.fromEntries(
  TAXONOMY.map((cat) => [cat.label, cat.subcategories.map((s) => s.label)])
);
