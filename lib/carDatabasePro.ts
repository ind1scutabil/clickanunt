/**
 * Car Database Pro - Enterprise Database
 * Stub for CarSelectorPro component
 */
...
export const COMPLETE_CAR_DATABASE: CarMakeInfo[] = [
  ...
  { id: 'alfa-romeo', name: 'Alfa Romeo', country: 'Italy', models: modelsData['Alfa Romeo'] },
  { id: 'maserati', name: 'Maserati', country: 'Italy', models: modelsData['Maserati'] },
  { id: 'ferrari', name: 'Ferrari', country: 'Italy', models: modelsData['Ferrari'] },
  { id: 'lamborghini', name: 'Lamborghini', country: 'Italy', models: modelsData['Lamborghini'] },
  { id: 'bugatti', name: 'Bugatti', country: 'France', models: modelsData['Bugatti'] },
  { id: 'rolls-royce', name: 'Rolls-Royce', country: 'UK', models: modelsData['Rolls-Royce'] },
  { id: 'bentley', name: 'Bentley', country: 'UK', models: modelsData['Bentley'] },
  { id: 'jaguar', name: 'Jaguar', country: 'UK', models: modelsData['Jaguar'] },
  { id: 'land-rover', name: 'Land Rover', country: 'UK', models: modelsData['Land Rover'] },
  { id: 'aston-martin', name: 'Aston Martin', country: 'UK', models: modelsData['Aston Martin'] },
];
...
export function getAllBrandNames(): string[] {
  return COMPLETE_CAR_DATABASE.map(m => m.name);
}
